...
demo_sample_script_file_path = r"C:\Users\ANKIT\Documents\VScode\prodigal_reports\Podcast\demo_sample_script.txt"
with open(demo_sample_script_file_path, 'r', encoding='utf-8') as file:
    demo_sample_script = file.read()
...
def generate():
    ...
    contents = [
        types.Content(
            role="user",
            parts=[
                types.Part.from_text(text=demo_sample_script),
...
# Gemini: Agree, let's see what our viewer thinks about it."""),
    ...
    for chunk in client.models.generate_content_stream(
        ...
        if chunk.candidates[0].content.parts[0].inline_data:
            file_name = "gemini_tts_demo_sample_script"
